...
// particlesMaterial.color = new THREE.Color("#b077ba")
...
const tick = () => {
  ...
  // ROTATE ALL APRTICLES TOGETHER
  particles.rotation.y = -elapsedTime * 0.15
  particles.rotation.x = -elapsedTime * 0.1
//   particles.rotation.x = -elapsedTime * 0.05 * Math.random()
  particles.rotation.z = elapsedTime * 0.1

  // PARTICLES WAVE - BAD PERFORMANCE - NEED SHADERS
